...
exports.default = (function (cmd) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, build, clean, root, tarFolder, spinning, pkg, pkgName, tarFolderName, tarName, cacheTarFolder, files, output, archive;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                _a = cmd, build = _a.build, clean = _a.clean;
                root = process.cwd();
                ...
                return [4, (0, utils_1.exec)('yarn build')];
            case 1:
                _b.sent();
                _b.label = 2;
            case 2:
                files = ['config', 'server', 'mock', 'dist', 'package.json', '.env', '.env.production'];
                ...
                return [4, (0, utils_1.exec)('yarn install --production')];
            case 3:
                _b.sent();
                shell.cd(tarFolder);
